...
int8_t initHw()
{
    ...
    // CONFIGURE LED
    // LARGE    RED:PC4  GREEN:PF0  BLUE:PE4  BCKLGT: PF3
    ...
    GPIO_PORTF_AFSEL_R |= (   BT_3 | BT_0   );
    GPIO_PORTC_PCTL_R  |= GPIO_PCTL_PC4_M0PWM6;
    GPIO_PORTE_PCTL_R  |= GPIO_PCTL_PE4_M0PWM4;
    GPIO_PORTF_PCTL_R  |= (GPIO_PCTL_PF3_M1PWM7 | GPIO_PCTL_PF0_M1PWM4);
    ...
    SYSCTL_SRPWM_R     |= SYSCTL_SRPWM_R0;                                // Reset PWM0 module and leave reset state
...
//    *BITBAND(GPIO_PORTB_DATA_R,5) = 0;
    ...
    // Define outputs (set bits)
    GPIO_PORTA_DIR_R |=  (    BT_5 |        BT_3 | BT_2   )  ;
    GPIO_PORTC_DIR_R |=  (    BT_5                        )  ;

    // Set output level
    GPIO_PORTA_DR4R_R |=  (   BT_5 |        BT_3 | BT_2   )  ;
    GPIO_PORTC_DR4R_R |=  (   BT_5                        )  ;
    ...
    // SCR=0   SPH=0   SPO=0   FRF=0   DSS=8 (9bit data) Top 16 bits are reserved and untouched
